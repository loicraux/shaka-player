...
## [5.0.0](https://github.com/shaka-project/shaka-player/compare/v4.7.0...v5.0.0) (2024-03-07)


### ⚠ BREAKING CHANGES

* Prefer MSE HLS over native HLS in Apple platform when not encrypted ([#6188](https://github.com/shaka-project/shaka-player/issues/6188))
* Remove com.adobe.primetime keysystem ([#6189](https://github.com/shaka-project/shaka-player/issues/6189))
